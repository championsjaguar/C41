class Game {
  ...
  play(){
    ...
    if(player.distance > 4200 && passedFinished===false){
    ...
    drawSprites();
          ...
          displayRank()
          {
              ...
              imageMode(CENTER);
              Player.getPlayerInfo();
              image(bg,displayWidth/-4,-100+displayHeight/9,200,240);
              image(sg,displayWidth/4,-100+displayHeight/10,225,270);
              image(gg,0,-100,250,300);
              textAlign(CENTER);
              textSize(50);
              for(var plr in allPlayers)
              {
